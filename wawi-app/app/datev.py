"""
CAO-XT WaWi-App – DATEV-Export-Modul

Integriert das bestehende datevexport-Paket in die WaWi-App:
...
# datevexport-Paket liegt im Repo-Root, eine Ebene über wawi-app/
