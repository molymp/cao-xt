...
if($usr_rights)
  {
    if($_GET['action']=="detail")
      {
        // Header: main.php?section=".$_GET['section']."&module=agjourn&action=details&id=xxxxxxx
    ...
    elseif($_GET['action']=="create")
    ...
    else
      {
        if(!$_GET['month'])
          {
            // Header: main.php?section=".$_GET['section']."&module=agjourn
          ...
          {
            // Header: main.php?section=".$_GET['section']."&module=agjourn&month=xx&year=xxxx
	...
	if($ini_navstyle == "classic")
	  {
           ...
           $o_navi = "<table width=\"300\" cellpadding=\"0\" cellspacing=\"0\"><tr><td class=\"head\" align=\"right\" valign=\"middle\">".$m_name."&nbsp;".$year."</td><td align=\"right\" valign=\"middle\"><table width=\"16\" height=\"16\" cellpadding=\"0\" cellspacing=\"2\"><tr><td bgcolor=\"#d4d0c8\" align=\"center\" valign=\"middle\"><a href=\"main.php?section=".$_GET['section']."&module=agjourn&action=list&month=".$next_month."&year=".$next_year."\"><img src=\"images/p_up.gif\" border=\"0\"></a></td></tr><tr><td bgcolor=\"#d4d0c8\" align=\"center\" valign=\"middle\"><a href=\"main.php?section=".$_GET['section']."&module=agjourn&action=list&month=".$last_month."&year=".$last_year."\"><img src=\"images/p_down.gif\" border=\"0\"></a></td></tr></table></td></tr></table>";
	  }
	else
	  {
        ...
        $res_id = mysql_query("SELECT REC_ID, VRENUM, RDATUM, KUN_NAME1, KUN_NAME2, NSUMME, MSUMME, BSUMME, WAEHRUNG FROM JOURNAL WHERE QUELLE=1 AND MONTH(RDATUM)=".$month." AND YEAR(RDATUM)=".$year." ORDER BY ".$sql_oname." ".$sql_otype, $db_id);
        ...
        $o_cont = "<table width=\"100%\" cellpadding=\"0\" cellspacing=\"1\"><tr bgcolor=\"#d4d0c8\"><td width=\"16\"><img src=\"images/leer.gif\"></td><td>&nbsp;<a href=\"main.php?section=".$_GET['section']."&module=agjourn&month=".$_GET['month']."&year=".$_GET['year']."&oname=rechnung&otype=".$otype."\">Beleg</a></td><td>&nbsp;<a href=\"main.php?section=".$_GET['section']."&module=agjourn&month=".$_GET['month']."&year=".$_GET['year']."&oname=datum&otype=".$otype."\">Datum</a></td><td>&nbsp;<a href=\"main.php?section=".$_GET['section']."&module=agjourn&month=".$_GET['month']."&year=".$_GET['year']."&oname=name&otype=".$otype."\">Name des Kunden</b></td><td>&nbsp;<a href=\"main.php?section=".$_GET['section']."&module=agjourn&month=".$_GET['month']."&year=".$_GET['year']."&oname=netto&otype=".$otype."\">Netto</a></td><td>&nbsp;MwSt</td><td>&nbsp;<a href=\"main.php?section=".$_GET['section']."&module=agjourn&month=".$_GET['month']."&year=".$_GET['year']."&oname=brutto>&otype=".$otype."\">Brutto</a></td><td colspan=\"2\">&nbsp;Belegkopie</td><td>&nbsp;Belegdruck</td></tr>";
        foreach($result as $row)
          {
            ...
            if($color%2)
              {
                $o_cont .= "<tr bgcolor=\"#ffffff\"><td width=\"16\" bgcolor=\"#d4d0c8\"><img src=\"images/leer.gif\"></td><td><a href=\"main.php?section=".$_GET['section']."&module=agjourn&action=detail&id=".$row['REC_ID']."\">&nbsp;".$row['VRENUM']."</a></td><td><a href=\"main.php?section=".$_GET['section']."&module=agjourn&action=detail&id=".$row['REC_ID']."\">&nbsp;".$row['RDATUM']."</a></td><td><a href=\"main.php?section=".$_GET['section']."&module=agjourn&action=detail&id=".$row['REC_ID']."\">&nbsp;".$row['KUN_NAME1']." ".$row['KUN_NAME2']."</a></td><td align=\"right\"><a href=\"main.php?section=".$_GET['section']."&module=agjourn&action=detail&id=".$row['REC_ID']."\">&nbsp;".number_format($row['NSUMME'], 2, ",", ".")." &euro;</a></td><td align=\"right\"><a href=\"main.php?section=".$_GET['section']."&module=agjourn&action=detail&id=".$row['REC_ID']."\">&nbsp;".number_format($row['MSUMME'], 2, ",", ".")." &euro;</a></td><td align=\"right\"><a href=\"main.php?section=".$_GET['section']."&module=agjourn&action=detail&id=".$row['REC_ID']."\">&nbsp;".number_format($row['BSUMME'], 2, ",", ".")." &euro;</a></td><td align=\"center\"><a href=\"main.php?section=".$_GET['section']."&module=agjourn&action=create&type=angebot&id=".$row['REC_ID']."\">&nbsp;Angebot</a></td><td align=\"center\"><a href=\"main.php?section=".$_GET['section']."&module=agjourn&action=create&type=rechnung&id=".$row['REC_ID']."\">&nbsp;Rechnung</a></td><td align=\"center\"><a href=\"report.php?module=angebot&id=".$row['REC_ID']."\" target=\"_blank\">&nbsp;Formular</a></td></tr>";
              }
            else
              {
                $o_cont .= "<tr bgcolor=\"#ffffdd\"><td width=\"16\" bgcolor=\"#d4d0c8\"><img src=\"images/leer.gif\"></td><td><a href=\"main.php?section=".$_GET['section']."&module=agjourn&action=detail&id=".$row['REC_ID']."\">&nbsp;".$row['VRENUM']."</a></td><td><a href=\"main.php?section=".$_GET['section']."&module=agjourn&action=detail&id=".$row['REC_ID']."\">&nbsp;".$row['RDATUM']."</a></td><td><a href=\"main.php?section=".$_GET['section']."&module=agjourn&action=detail&id=".$row['REC_ID']."\">&nbsp;".$row['KUN_NAME1']." ".$row['KUN_NAME2']."</a></td><td align=\"right\"><a href=\"main.php?section=".$_GET['section']."&module=agjourn&action=detail&id=".$row['REC_ID']."\">&nbsp;".number_format($row['NSUMME'], 2, ",", ".")." &euro;</a></td><td align=\"right\"><a href=\"main.php?section=".$_GET['section']."&module=agjourn&action=detail&id=".$row['REC_ID']."\">&nbsp;".number_format($row['MSUMME'], 2, ",", ".")." &euro;</a></td><td align=\"right\"><a href=\"main.php?section=".$_GET['section']."&module=agjourn&action=detail&id=".$row['REC_ID']."\">&nbsp;".number_format($row['BSUMME'], 2, ",", ".")." &euro;</a></td><td align=\"center\"><a href=\"main.php?section=".$_GET['section']."&module=agjourn&action=create&type=angebot&id=".$row['REC_ID']."\">&nbsp;Angebot</a></td><td align=\"center\"><a href=\"main.php?section=".$_GET['section']."&module=agjourn&action=create&type=rechnung&id=".$row['REC_ID']."\">&nbsp;Rechnung</a></td><td align=\"center\"><a href=\"report.php?module=angebot&id=".$row['REC_ID']."\" target=\"_blank\">&nbsp;Formular</a></td></tr>";
              }
