...
if($usr_rights)
  {
   if($db_res = mysql_query("SELECT ART_ID, E_BEST as Bestand FROM ".$db_pref."BEST WHERE E_BEST!=0", $db_id))
     {
   ...
   $o_cont .= "<tr><td></td><td bgcolor=\"#ffffff\" align=\"center\"><br><br>&nbsp;Es sind insgesamt <b>".$a_anzahl." Artikel</b> mit einem EK-Gesamtwert von <b>".number_format($a_wert, 2, ",", ".")." &euro;</b> im Eigenbestand.<br><br></div>";
  }
else
  {
