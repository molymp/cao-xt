...
if($usr_rights)
  {
    if($_GET['action']=="all")
      {
        // Header: main.php?section=".$_GET['section']."&module=angebot&action=all&id=xxxxxxx
	...
	// Javascripte
        ...
        $o_cont .= "<form action=\"main.php?section=".$_GET['section']."&module=angebot&action=all&id=".$_GET['id']."\" method=\"post\" name=\"TARGET\">";
        ...
        $o_cont .= "<form action=\"main.php?section=".$_GET['section']."&module=angebot&action=all&id=".$_GET['id']."\" method=\"post\" name=\"maindata\">";
        ...
        $o_cont .=  "<table width=\"100%\" cellpadding=\"6\" cellspacing=\"0\"><tr>
                      <td width=\"33%\" align=\"center\" valign=\"middle\" bgcolor=\"#d4d0c8\">
                       <a href=\"main.php?section=".$_GET['section']."&module=angebot&action=all&id=new\" onMouseOver=\"change('s_new_', 'on')\"  onMouseOut=\"change('s_new_', 'off')\"><img name=\"s_new_\" src=\"images/s_new_off.gif\" width=97 height=26 border=0 alt=\"\"></a>
                      </td>
                      ...
                      <td width=\"33%\" align=\"center\" valign=\"middle\" bgcolor=\"#d4d0c8\">
                       <a href=\"main.php?section=".$_GET['section']."&module=angebot&action=delete&id=".$_GET['id']."\" onMouseOver=\"change('s_del_', 'on')\"  onMouseOut=\"change('s_del_', 'off')\"><img name=\"s_del_\" src=\"images/s_del_off.gif\" width=102 height=26 border=0 alt=\"\"></a>
                      </td>
                     </tr></table>";
    ...
    elseif($_GET['action']=="pos")
      {
        // Header: main.php?section=".$_GET['section']."&module=angebot&action=pos&id=xxxxxxx
        ...
        if($_GET['do']=="delete")		// Position löschen
          {
            ...
            if(($temp['JOURNAL_ID']==$_GET['id'])&&($temp['QUELLE']=="11"))	// Sicherheitsabfragen gegen Unfug
              {
        ...
        if($maindata['BRUTTO_FLAG']=='Y')
          {
            $o_head = "Angebot bearbeiten ... (BRUTTO)";
          }
        else
          {
            $o_head = "Angebot bearbeiten ...";
        ...
        if($_SESSION['hidden']=="TRUE")
          {
            $o_cont .= "<tr><td bgcolor=\"#ffffdd\" colspan=\"15\" valign=\"middle\"><b>&nbsp;Kalkulation</b><img src=\"images/slash.gif\" style=\"vertical-align:middle\"></td><td bgcolor=\"#ffffdd\" valign=\"middle\" align=\"center\"><a href=\"main.php?section=".$_GET['section']."&module=angebot&action=pos&option=show&id=".$_GET['id']."\"><image src=\"images/checkbox_off.gif\" border=\"0\"></a></td></tr>";
          }
        else
          {
            $o_cont .= "<tr><td bgcolor=\"#ffffdd\" colspan=\"15\" valign=\"middle\"><b>&nbsp;Kalkulation</b><img src=\"images/slash.gif\" style=\"vertical-align:middle\"></td><td bgcolor=\"#ffffdd\" valign=\"middle\" align=\"center\"><a href=\"main.php?section=".$_GET['section']."&module=angebot&action=pos&option=hide&id=".$_GET['id']."\"><image src=\"images/checkbox_on.gif\" border=\"0\"></a></td></tr>";
            $o_cont .= "<tr><td bgcolor=\"#ffffdd\" colspan=\"16\" align=\"center\">";
            $o_cont .= "<table width=\"98%\" cellpadding=\"2\" cellspacing=\"0\"><tr bgcolor=\"#ffffdd\">";
        ...
        $o_cont .= "<tr bgcolor=\"#d4d0c8\"><td width=\"16\"><img src=\"images/leer.gif\"></td><td width=\"38\">&nbsp;Pos.</td><td width=\"16\">&nbsp;T</td><td>&nbsp;Artikelnummer</td><td colspan=\"2\">&nbsp;Artikelbezeichnung</td><td>&nbsp;Menge</td><td>&nbsp;M.-Einheit</td><td>&nbsp;E-Preis (Roh-G.)</td><td>&nbsp;Rabatt</td><td>&nbsp;G-Preis (Roh-G.)</td><td width=\"16\">&nbsp;S</td><td>&nbsp;MwSt</td><td>&nbsp;Gewicht(Kg)</td><td>&nbsp;</td><td>&nbsp;</td></tr>";
        ...
        for($j=0; $j<$number; $j++)
          {
            ...
            if($j%2)
              {
                $o_cont .= "<form action=\"main.php?section=".$_GET['section']."&module=angebot&action=pos&id=".$_GET['id']."\" method=\"post\" name=\"".$posdata[$j]['REC_ID']."\"><tr bgcolor=\"#ffffdd\" valign=\"top\"><td width=\"16\" bgcolor=\"#d4d0c8\"><img src=\"images/leer.gif\"></td><td><select size=\"1\" name=\"POSITION\" style=\"width:38px;\">".$posdata[$j]['POS']."\"</select></td><td><input type=\"text\" name=\"ARTIKELTYP\" style=\"width:16px;\" value=\"".$posdata[$j]['ARTIKELTYP']."\" readonly></td><td><input type=\"text\" name=\"ARTNUM\" style=\"width:60px;\" value=\"".$posdata[$j]['ARTNUM']."\" readonly></td><td colspan=\"2\"><textarea name=\"BEZEICHNUNG\" cols=\"50\" rows=\"4\">".$posdata[$j]['BEZEICHNUNG']."</textarea></td><td><input type=\"text\" name=\"MENGE\" style=\"width:40px; ".$m_style."\" value=\"".number_format($posdata[$j]['MENGE'], 2, ',', '')."\"></td><td><input type=\"text\" name=\"ME_EINHEIT\" style=\"width:60px;\" value=\"".$posdata[$j]['ME_EINHEIT']."\"></td><td>".$epreis."</td><td><input type=\"text\" name=\"RABATT\" style=\"width:40px;\" value=\"".number_format($posdata[$j]['RABATT'], 2, ',', '')." %\"></td><td>".$gpreis."</td><td><input type=\"text\" name=\"STEUER_CODE\" style=\"width:16px;\" value=\"".$posdata[$j]['STEUER_CODE']."\"></td><td><input type=\"text\" name=\"MWST\" style=\"width:40px;\" value=\"".$mwst_total." %\" readonly></td><td><input type=\"text\" name=\"GEWICHT\" style=\"width:40px;\" value=\"".number_format($posdata[$j]['GEWICHT'], 2, ',', '')."\"></td><td width=\"16\"><input type=\"submit\" name=\"SUBMIT\" value=\"&Auml;ndern\"></td><td width=\"16\"><button name=\"delete\" type=\"button\" value=\"L&ouml;schen\" onClick=\"self.location.href='main.php?section=".$_GET['section']."&module=angebot&action=pos&do=delete&pos=".$posdata[$j]['REC_ID']."&id=".$_GET['id']."'\">L&ouml;schen</button></td></tr><input type=\"hidden\" name=\"REC_ID\" value=\"".$posdata[$j]['REC_ID']."\"><input type=\"hidden\" name=\"EK_PREIS\" value=\"".$posdata[$j]['EK_PREIS']."\"></form>";
              }
            else
              {
        ...
        $o_cont .= "<tr bgcolor=\"#ffffff\"><td colspan=\"16\" align=\"center\"><br><br><button name=\"add_art\" onclick=\"open_artid(); return false\"><b>Artikel hinzuf&uuml;gen</b></button><br><br><br>
                    <form action=\"main.php?section=".$_GET['section']."&module=angebot&action=pos&id=".$_GET['id']."\" method=\"post\" name=\"TARGET\"><input type=\"hidden\" name=\"ARTIKEL_ID\" value=\"\"></form>";
    ...
    elseif(($_GET['action']=="delete") && ($_GET['type']!="submit"))
      {
        // Header: main.php?section=".$_GET['section']."&module=angebot&action=delete&id=xxxxxxx

        $o_navi = print_navi($_GET['id'], $_GET['section']);

        $o_cont = "<table width=\"100%\" height=\"100%\" cellpadding=\"0\" cellspacing=\"1\"><tr><td align=\"center\" valign=\"middle\" style=\"background: #ffffdd;\">";
        $o_cont .= "<br><br><br><br><br><br><br><br>Wollen Sie den Beleg wirklich l&ouml;schen?<br><a href=\"main.php?section=".$_GET['section']."&module=angebot&action=delete&type=submit&id=".$_GET['id']."\">JA</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"main.php?section=".$_GET['section']."&module=angebot&action=all&id=".$_GET['id']."\">NEIN</a><br><br><br><br><br><br><br><br>";
        $o_cont .= "</td></tr></table>";
      }
    elseif(($_GET['action']=="delete") && ($_GET['type']=="submit"))
      {
        // Header: main.php?section=".$_GET['section']."&module=angebot&action=delete&type=submit&id=xxxxxxx
        ...
        if(!mysql_query("DELETE FROM JOURNAL WHERE REC_ID=".$_GET['id'], $db_id))
          {
            $o_cont .= "<br><br><br><br><br><br><br><br>FEHLER: ".mysql_error($db_id)."<br><a href=\"main.php?section=".$_GET['section']."&module=angebot&action=list\">Zur &Uuml;bersicht</a><br><br><br><br><br><br><br><br>";
          }
        else
          {
            ...
            $o_cont .= "<br><br><br><br><br><br><br><br>Beleg erfolgreich gel&ouml;scht!<br><a href=\"main.php?section=".$_GET['section']."&module=angebot&action=list\">Zur &Uuml;bersicht</a><br><br><br><br><br><br><br><br>";
          }
    ...
    elseif(($_GET['action']=="finalise") && ($_GET['type']!="submit"))
      {
        // Header: main.php?section=".$_GET['section']."&module=angebot&action=finalize&id=xxxxxxx
        ...
        if($error=="")
          {
            ...
            $o_cont .= "<br><br><form action=\"main.php?section=".$_GET['section']."&module=angebot&action=finalise&type=submit&id=".$_GET['id']."\" method=\"post\"><input type=\"submit\" value=\"Angebot Speichern\"><input type=\"hidden\" name=\"checked\" value=\"TRUE\"></form><br>";
          }
        else
          {
          	$o_cont .= "<div style=\"color: #ff0000; font-weight: bold;\"><br><br><br><br><br><br><br><br>".$error."<br><br><br><br><br><br><br><br></div>";
            $o_cont .= "</td></tr><tr><td align=\"center\" valign=\"middle\" style=\"background: #ffffff;\">";
            $o_cont .= "<br><br><form action=\"main.php?section=".$_GET['section']."&module=angebot&action=pos&id=".$_GET['id']."\" method=\"post\"><input type=\"submit\" value=\"Positionen bearbeiten\"></form><br>";
          }
        $o_cont .= "</td></tr>";
        $o_cont .= "</table>";
      }
    elseif(($_GET['action']=="finalise") && ($_GET['type']=="submit"))
      {
        // Header: main.php?section=".$_GET['section']."&module=angebot&action=finalize&type=submit&id=xxxxxxx

        if($_POST['checked']=="TRUE")
          {
            // Daten sammeln, Angebotsnummer erstellen, Stadium
            ...
            $rec_id = mysql_query("SELECT VAL_INT2, VAL_INT3, VAL_CHAR FROM REGISTRY WHERE MAINKEY='MAIN\\\\NUMBERS' AND NAME='VK-AGB'", $db_id);
            $rec_tmp = mysql_fetch_array($rec_id, MYSQL_ASSOC);
            mysql_free_result($rec_id);
            ...
            $rec_id = mysql_query("UPDATE REGISTRY SET VAL_INT2='".$rec_tmp['VAL_INT2']."' WHERE MAINKEY='MAIN\\\\NUMBERS' AND NAME='VK-AGB'", $db_id);

            // Journal und Journalpos buchen:

            mysql_query("UPDATE JOURNAL SET VRENUM='".$vrenum."', RDATUM=CURDATE(), QUELLE=1, QUELLE_SUB=1 WHERE REC_ID=".$_GET['id'], $db_id);

            mysql_query("UPDATE JOURNALPOS SET QUELLE=3, QUELLE_SUB=1, VIEW_POS=1 WHERE JOURNAL_ID=".$_GET['id'], $db_id);
           ...
           $o_navi = "<table width=\"4\" height=\"100%\" cellpadding=\"0\" cellspacing=\"0\"><tr>
            ...
            $o_cont .= "<table width=\"98%\" cellpadding=\"2\" cellspacing=\"0\"><tr bgcolor=\"#ffffdd\">";
            $o_cont .= "<td>Kunden-Nr.:</td><td><input type=\"text\" name=\"KUN_NUM\" style=\"width:60px;\" value=\"".$addrdata['KUNNUM1']."\" readonly></td><td>Kunde:</td><td colspan=\"3\" width=\"400\"><input type=\"text\" name=\"KUN_NAME\" style=\"width:400px;\" value=\"".$addrdata['ANREDE']." ".$addrdata['NAME1']." ".$addrdata['NAME2']." ".$addrdata['NAME3']."\" readonly></td><td>Telefon1:</td><td><input type=\"text\" name=\"KUN_TELE1\" style=\"width:100px;\" value=\"".$addrdata['TELE1']."\" readonly></td><td>Mobilfunk:</td><td><input type=\"text\" name=\"KUN_FUNK\" style=\"width:100px;\" value=\"".$addrdata['FUNK']."\" readonly></td></tr>";
            $o_cont .= "<tr><td>Angebots-Nr.:</td><td><input type=\"text\" name=\"NUMMER\" style=\"width:60px;\" value=\"".$vrenum."\" readonly></td><td>Land/Plz/Ort:</td><td><input type=\"text\" name=\"KUN_LAND\" style=\"width:30px;\" value=\"".$addrdata['LAND']."\" readonly></td><td><input type=\"text\" name=\"KUN_PLZ\" style=\"width:60px;\" value=\"".$addrdata['PLZ']."\" readonly></td><td><input type=\"text\" name=\"KUN_ORT\" style=\"width:300px;\" value=\"".$addrdata['ORT']."\" readonly></td><td>Telefon2:</td><td><input type=\"text\" name=\"KUN_TELE2\" style=\"width:100px;\" value=\"".$addrdata['TELE2']."\" readonly></td><td>Fax:</td><td><input type=\"text\" name=\"KUN_FAX\" style=\"width:100px;\" value=\"".$addrdata['FAX']."\" readonly></td>";
            $o_cont .= "</tr></table></td></tr>";
            ...
            $o_cont .= "<tr><td align=\"center\" valign=\"middle\" style=\"background: #ffffdd;\">";
          	$o_cont .= "<div style=\"color: #000000; font-weight: bold;\"><br><br><br><br><br><br><br><br>Angebot gespeichert<br><br><br><br><br><br><br><br></div>";
            $o_cont .= "</td></tr><tr><td align=\"center\" valign=\"middle\" style=\"background: #ffffff;\">";
            $o_cont .= "<br><br><form action=\"report.php?module=angebot&id=".$_GET['id']."\" method=\"post\" target=\"_blank\"><input type=\"submit\" value=\"Beleg anzeigen\"><input type=\"hidden\" name=\"user\" value=\"".$usr_name."\"></form><br>";
            $o_cont .= "</td></tr>";
            $o_cont .= "</table>";
          }
        else
          {
            ...
            $o_cont .= "</td></tr><tr><td align=\"center\" valign=\"middle\" style=\"background: #ffffff;\">";
            $o_cont .= "<br><br><form action=\"main.php?section=".$_GET['section']."&module=angebot&action=finalise&id=".$_GET['id']."\" method=\"post\"><input type=\"submit\" value=\"Fehler anzeigen\"></form><br>";
            $o_cont .= "</td></tr>";
            $o_cont .= "</table>";
          }
      }
    else						// Belegliste
      {
        ...
        $res_id = mysql_query("SELECT REC_ID, VRENUM, KUN_NUM, KUN_ANREDE, KUN_NAME1, KUN_NAME2, KUN_NAME3, PROJEKT, NSUMME, RDATUM, TERMIN, ZAHLART, LIEFART, STADIUM, ERST_NAME FROM JOURNAL WHERE QUELLE=11 ORDER BY ".$sql_oname." ".$sql_otype, $db_id);
        $res_num = mysql_numrows($res_id);
        $result = array();
        ...
        $o_cont = "<table width=\"100%\" cellpadding=\"0\" cellspacing=\"1\"><tr bgcolor=\"#d4d0c8\"><td width=\"16\"><img src=\"images/leer.gif\"></td><td>&nbsp;<a href=\"main.php?section=".$_GET['section']."&module=angebot&oname=nummer&otype=".$otype."\">int. Nr.</a></td><td>&nbsp;<a href=\"main.php?section=".$_GET['section']."&module=angebot&oname=kunnum&otype=".$otype."\">Ku.-Nr.</b></td><td>&nbsp;<a href=\"main.php?section=".$_GET['section']."&module=angebot&oname=name&otype=".$otype."\">Kunde</a></td><td>&nbsp;<a href=\"main.php?section=".$_GET['section']."&module=angebot&oname=projekt&otype=".$otype."\">Projekt / Beschreibung</a></td><td>&nbsp;<a href=\"main.php?section=".$_GET['section']."&module=angebot&oname=netto&otype=".$otype."\">Summe Netto</a></td><td>&nbsp;<a href=\"main.php?section=".$_GET['section']."&module=angebot&oname=datum&otype=".$otype."\">le.&Auml;nderung</a></td><td>&nbsp;<a href=\"main.php?section=".$_GET['section']."&module=angebot&oname=termin&otype=".$otype."\">Termin</a></td><td>&nbsp;<a href=\"main.php?section=".$_GET['section']."&module=angebot&oname=zahlart&otype=".$otype."\">Zahlart</a></td><td>&nbsp;<a href=\"main.php?section=".$_GET['section']."&module=angebot&oname=liefart&otype=".$otype."\">Versand</a></td><td>&nbsp;<a href=\"main.php?section=".$_GET['section']."&module=angebot&oname=erstellt&otype=".$otype."\">Erstellt</a></td></tr>";
            ...
            if(!strstr($row['VRENUM'], "EDI"))
              {
                ...
                if($color%2)
                  {
                    $o_cont .= "<tr bgcolor=\"#ffffff\"><td width=\"16\" bgcolor=\"#d4d0c8\"><img src=\"images/leer.gif\"></td><td align=\"center\"><a href=\"main.php?section=".$_GET['section']."&module=angebot&action=pos&id=".$row['REC_ID']."\">&nbsp;".$row['VRENUM']."</a></td><td align=\"center\"><a href=\"main.php?section=".$_GET['section']."&module=angebot&action=pos&id=".$row['REC_ID']."\">&nbsp;".$row['KUN_NUM']."</a></td><td><a href=\"main.php?section=".$_GET['section']."&module=angebot&action=pos&id=".$row['REC_ID']."\">&nbsp;".$temp_name."</a></td><td align=\"left\"><a href=\"main.php?section=".$_GET['section']."&module=angebot&action=pos&id=".$row['REC_ID']."\">&nbsp;".$row['PROJEKT']."</a></td><td align=\"right\"><a href=\"main.php?section=".$_GET['section']."&module=angebot&action=pos&id=".$row['REC_ID']."\">&nbsp;".number_format($row['NSUMME'], 2, ",", ".")." &euro;</a></td><td align=\"center\"><a href=\"main.php?section=".$_GET['section']."&module=angebot&action=pos&id=".$row['REC_ID']."\">&nbsp;".$row['RDATUM']."</a></td><td><a href=\"main.php?section=".$_GET['section']."&module=angebot&action=pos&id=".$row['REC_ID']."\">&nbsp;".$row['TERMIN']."</a></td><td><a href=\"main.php?section=".$_GET['section']."&module=angebot&action=pos&id=".$row['REC_ID']."\">&nbsp;".$row['ZAHLART']."</a></td><td><a href=\"main.php?section=".$_GET['section']."&module=angebot&action=pos&id=".$row['REC_ID']."\">&nbsp;".$row['LIEFART']."</a></td><td><a href=\"main.php?section=".$_GET['section']."&module=angebot&action=pos&id=".$row['REC_ID']."\">&nbsp;".$row['ERST_NAME']."</a></td></tr></a>";

                  }
                else
                  {
                    $o_cont .= "<tr bgcolor=\"#ffffdd\"><td width=\"16\" bgcolor=\"#d4d0c8\"><img src=\"images/leer.gif\"></td><td align=\"center\"><a href=\"main.php?section=".$_GET['section']."&module=angebot&action=pos&id=".$row['REC_ID']."\">&nbsp;".$row['VRENUM']."</a></td><td align=\"center\"><a href=\"main.php?section=".$_GET['section']."&module=angebot&action=pos&id=".$row['REC_ID']."\">&nbsp;".$row['KUN_NUM']."</a></td><td><a href=\"main.php?section=".$_GET['section']."&module=angebot&action=pos&id=".$row['REC_ID']."\">&nbsp;".$temp_name."</a></td><td align=\"left\"><a href=\"main.php?section=".$_GET['section']."&module=angebot&action=pos&id=".$row['REC_ID']."\">&nbsp;".$row['PROJEKT']."</a></td><td align=\"right\"><a href=\"main.php?section=".$_GET['section']."&module=angebot&action=pos&id=".$row['REC_ID']."\">&nbsp;".number_format($row['NSUMME'], 2, ",", ".")." &euro;</a></td><td align=\"center\"><a href=\"main.php?section=".$_GET['section']."&module=angebot&action=pos&id=".$row['REC_ID']."\">&nbsp;".$row['RDATUM']."</a></td><td><a href=\"main.php?section=".$_GET['section']."&module=angebot&action=pos&id=".$row['REC_ID']."\">&nbsp;".$row['TERMIN']."</a></td><td><a href=\"main.php?section=".$_GET['section']."&module=angebot&action=pos&id=".$row['REC_ID']."\">&nbsp;".$row['ZAHLART']."</a></td><td><a href=\"main.php?section=".$_GET['section']."&module=angebot&action=pos&id=".$row['REC_ID']."\">&nbsp;".$row['LIEFART']."</a></td><td><a href=\"main.php?section=".$_GET['section']."&module=angebot&action=pos&id=".$row['REC_ID']."\">&nbsp;".$row['ERST_NAME']."</a></td></tr></a>";
                  }
              }
          }
