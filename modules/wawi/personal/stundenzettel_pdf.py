...
Datenquelle: :func:`modules.wawi.personal.models.stundenzettel_monat_daten`.
"""
...
def stundenzettel_als_pdf(daten: dict, firma_name: str = '') -> bytes:
    ...
    :func:`modules.wawi.personal.models.stundenzettel_monat_daten`.
    ...
    doc = SimpleDocTemplate(
        ...
        title=titel, author='CAO-XT WaWi-Personal',
    )
