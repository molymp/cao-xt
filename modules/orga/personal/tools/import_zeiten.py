...
Aufruf::
    ...
    python3 -m modules.orga.personal.tools.import_zeiten \\
...
from .import_csv import _init_orga_pool  # noqa: E402
...
def _loesche_import_stempel(pers_id: int, von: date, bis: date) -> int:
    ...
    from modules.orga.personal.models import get_db_rw
...
def _abwesenheit_exakt_vorhanden(pers_id: int, typ: str,
    ...
    from modules.orga.personal.models import get_db_ro
